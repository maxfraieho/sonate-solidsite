...
![Портфоліо — аудіоплеєр](../src/assets/screenshots/portfolio-audio.png)
...
![Портфоліо — фотогалерея та відео](../src/assets/screenshots/portfolio-gallery.png)
...
![Сторінка "Шлях інтеграції"](../src/assets/screenshots/integration-page.png)
...
![Сторінка контакту](../src/assets/screenshots/contact-page.png)
...
![Сторінка підтримки та співпраці](../src/assets/screenshots/support-page.png)
...
## Додаток: Скріншоти сайту

### A. Головна сторінка — Hero секція
![Hero секція головної сторінки](https://violin.pp.ua/og-image.jpg)
...
### C. Фотогалерея
*Професійні фотографії з концертів та студійних сесій.*

### D. Відеоконтент
*YouTube-інтеграція з lazy-loading для оптимальної продуктивності.*

### E. Сторінка контакту
*Інтерактивна карта, контактна форма та можливість бронювання виступів.*

### F. Сторінка підтримки
